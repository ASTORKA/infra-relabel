...
> - **selfsteal** — маскирующий сайт-заглушка (Caddy). Вендорен в репо
  (`selfsteal/selfsteal.sh`) — ставится из локальной копии без скачивания с
  GitHub (на DPI-сетях скачивание зависало); внутренние github-ссылки скрипта
  идут через `GH_PROXY`.
