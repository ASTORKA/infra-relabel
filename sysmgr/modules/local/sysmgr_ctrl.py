#!/usr/bin/env python3
# ============================================================ #
# ==        SYSMGR eBPF TRAFFIC LIMITER CONTROLLER         == #
# ==              sysmgr_ctrl.py  v4.0 (Multi-Rule)        == #
# ============================================================ #
#
...
DEFAULT_PIN_DIR   = "/sys/fs/bpf/sysmgr/maps"
DEFAULT_RULES_FILE = "/etc/sysmgr/traffic_limiter/rules.json"
...
def bpftool_map_update(pin_dir, map_name, key_hex, value_hex):
    ...
    if not os.path.exists(pin_path):
        ...
        print(f"   Убедись что сервис запущен: systemctl status sysmgr-traffic-limiter")
        sys.exit(1)
...
def build_parser():
    parser = argparse.ArgumentParser(
        description="Sysmgr eBPF Traffic Limiter Controller v4.0 (Multi-Rule)")
