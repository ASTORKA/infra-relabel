...
_get_traffic_limiter_status_string() {
    local config_dir="/etc/sysmgr/traffic_limiter"
...
WIDGET_CACHE_DIR="/tmp/sysmgr_widgets_cache"
...
show() {
    ...
    # --- Секция "Система" (жёсткое выравнивание, как в Primer/install_sysmgr.sh) ---
